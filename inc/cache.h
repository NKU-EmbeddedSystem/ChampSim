...
// #define LLC_MSHR_SIZE NUM_CPUS * 64 * 16
...
public:
  ...
  int check_hit(PACKET *packet), invalidate_entry(uint64_t inval_addr),
      ...
      va_prefetch_line(uint64_t ip, uint64_t pf_addr, int prefetch_fill_level,
                       uint32_t prefetch_metadata);
  ...
  void add_mshr(PACKET *packet), update_fill_cycle(),
      ...
      prefetcher_operate(uint64_t v_addr, uint64_t addr, uint64_t ip,
                         uint8_t cache_hit, uint8_t type),
      l1d_prefetcher_operate(uint64_t v_addr, uint64_t addr, uint64_t ip,
                             uint8_t cache_hit, uint8_t type),
      prefetcher_cache_fill(uint64_t v_addr, uint64_t addr, uint32_t set,
      ...
      llc_prefetcher_final_stats(), va_translate_prefetches();
  ...
  uint32_t l2c_prefetcher_operate(uint64_t v_addr, uint64_t addr, uint64_t ip,
                                  uint8_t cache_hit, uint8_t type,
                                  uint32_t metadata_in),
      llc_prefetcher_operate(uint64_t v_addr, uint64_t addr, uint64_t ip,
                             uint8_t cache_hit, uint8_t type,
                             uint32_t metadata_in),
      l2c_prefetcher_cache_fill(uint64_t v_addr, uint64_t addr, uint32_t set,
                                uint32_t way, uint8_t prefetch,
                                uint64_t evicted_addr, uint32_t metadata_in),
      llc_prefetcher_cache_fill(uint64_t v_addr, uint64_t addr, uint32_t set,
                                uint32_t way, uint8_t prefetch,
                                uint64_t evicted_addr, uint32_t metadata_in);
